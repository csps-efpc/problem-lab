# Contributor Covenant Code of Conduct for the Problem Lab
([Français](#Code-de-conduite-pour-le-projet-nom-du-projet))

Contributors to repositories hosted in Problem Lab are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the Values and Ethics Code for the Public Sector
...
This Code of Conduct applies both within project spaces and in public spaces when an individual is representing the project, members or the Canada School of Public Service.
Examples of representing a project, members or the Canada School of Public Service include using an official project e-mail address, posting via an official social media account, or acting as an appointed representative at an online or offline event.
Representation of a project may be further defined and clarified by project maintainers.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at incubate-incuber@csps-efpc.gc.ca .
...
# Code de conduite pour le Labo des problèmes
<!--markdownlint-enable MD025-->

([English](#Contributor-Covenant-Code-of-Conduct-for-the-projectname-project))

Les contributeurs aux dépôts hébergés dans « Labo des problèmes » sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le Code de valeurs et d'éthique du secteur public.
...
Les cas de comportement abusif, de harcèlement ou d'autres comportements inacceptables peuvent être rapportés en communiquant avec l'équipe de projet à l'adresse suivante : incubate-incuber@csps-efpc.gc.ca .
